...
const sliderUpdateHandler = () => {
  ...
  const effect = FILTERS[currentEffect];
...
const changeEffect = (effect) => {
  ...
  if (currentEffect !== 'none') {
    const effectObj = FILTERS[effect];
...
export { enableScaleChanger, disnableScaleChanger, enableEffectPreview, disableEffectPreview, picture, resetEffect };
